...
1. [Example Output: Reparative Metadata Lexicon](https://github.com/marriott-library/MaRMAT/blob/main/Code/example-output_reparative-metadata-lexicon.csv-lexicon)
